...
class GeminiEngine:
    ...
    def compose_dish_in_environment(self, dish_img_path, env_img_path):
        try:
            ...
            # ENDPOINT MIS À JOUR POUR IMAGEN 3 EN 2026
            endpoint = f"projects/{self.project}/locations/{self.location}/publishers/google/models/imagen-3.0-generate-002"
            ...
            prompt = (
                ...
                "Harmonise parfaitement la lumière ambiante et ajoute une ombre portée douce sous l'assiette."
            )
            ...
            print("[GEMINI VISUAL] Envoi de la demande de fusion à Imagen 3...")
            ...
            for prediction in response.predictions:
                if "bytesBase64Encoded" in prediction:
                    ...
                    with open(str(output_path), "wb") as f:
                        f.write(img_data)
                    print("[GEMINI VISUAL] Succès total avec Imagen 3 !")
